...
async function runLoop(progress, context, toolDefinitions, userTask, resultSchema, params) {
  ...
  const { tools, callTool, reportedResult } = (0, import_tool.toolsForLoop)(progress, context, toolDefinitions, { resultSchema });
  ...
  return { result: resultSchema ? reportedResult() : void 0 };
}
